    ...
    <LayoutPageSection>
      ...
      >
        <div class="mb-2">
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3">
              <div class="mt-12">
                ...
                <p class="font-ibm text-left">
                  ...
                  extasier devant la diversité des expertises.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <img class="" src="/img/bibliotheque/1.png" />
            <img class="h-30 w-60" src="/img/bibliotheque/2.png" />
            <img class="h-30 w-60" src="/img/bibliotheque/3.png" />
            <img class="h-30 w-60" src="/img/bibliotheque/4.png" />
            <img class="h-30 w-60" src="/img/bibliotheque/5.png" />
            <img class="h-30 w-60" src="/img/bibliotheque/6.png" />
          </div>
        </div>
        <div
      ...
      <div class="grid grid-cols-3 gap-x-4">
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/7.png" class="mb-5" />
          </NuxtLink>
        ...
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/8.png" class="mb-5" />
          </NuxtLink>
        ...
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/9.png" class="mb-5" />
          </NuxtLink>
      ...
      <div class="grid grid-cols-3 gap-x-4">
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/10.png" class="mb-5" />
          </NuxtLink>
        ...
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/11.png" class="mb-5" />
          </NuxtLink>
        ...
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/12.png" class="mb-5" />
          </NuxtLink>
      ...
      <div class="grid grid-cols-3 gap-x-4">
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/13.png" class="mb-5" />
          </NuxtLink>
        ...
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/14.png" class="mb-5" />
          </NuxtLink>
        ...
        <div>
          <NuxtLink to="/teeshirt">
            <AwesomeImages img="/img/bibliotheque/15.png" class="mb-5" />
          </NuxtLink>
